...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Estado est3 = new Estado("Rio de Janeiro");

        Cidade cid1 = new Cidade(null, "Uberlandia", est1);
        Cidade cid2 = new Cidade(null,"Uberaba", est1);
        Cidade cid3 = new Cidade(null,"Bauru", est2);
        Cidade cid4 = new Cidade(null,"Macatuba", est2);
        Cidade cid5 = new Cidade(null,"Barra Bonita", est2);
        Cidade cid6 = new Cidade(null,"Rio de Janeiro", est3);

        est1.getCidades().addAll(Arrays.asList(cid1, cid2));
        est2.getCidades().addAll(Arrays.asList(cid3, cid4, cid5));
        est3.getCidades().addAll(Arrays.asList(cid6));

        estadoRepository.saveAll(Arrays.asList(est1, est2, est3));
        cidadeRepository.saveAll(Arrays.asList(cid1, cid2, cid3, cid4, cid5, cid6));

        Cliente cli1 = new Cliente("Maria Silva", "maria@gmail.com", "36378912377", TipoCliente.FISICA);

        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Endereco e1 = new Endereco("Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, cid1);
        Endereco e2 = new Endereco("Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, cid2);
